...
var _venues = __webpack_require__(2);
...
var _VenueProcess = __webpack_require__(4);

var _VenueProcess2 = _interopRequireDefault(_VenueProcess);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var venueProcess = new _VenueProcess2.default(_venues2.default, _people2.default);

  var _venueProcess$doFilte = venueProcess.doFiltering(),
      _venueProcess$doFilte2 = _slicedToArray(_venueProcess$doFilte, 2),
      cango = _venueProcess$doFilte2[0],
      avoid = _venueProcess$doFilte2[1];
...
module.exports = [{"name":"El Cantina","food":["Mexican"],"drinks":["Soft drinks","Tequila","Beer"]},{"name":"Twin Dynasty","food":["Chinese"],"drinks":["Soft Drinks","Rum","Beer","Whisky","Cider"]},{"name":"Spice of life","food":["Eggs","Meat","Fish","Pasta","Dairy"],"drinks":["Vokda","Gin","whisky","Rum","Cider","Beer","Soft drinks"]},{"name":"The Cambridge","food":["Eggs","Meat","Fish","Pasta","Dairy"],"drinks":["Vokda","Gin","Cider","Beer","Soft drinks"]},{"name":"Wagamama","food":["Japanese"],"drinks":["Beer","Cider","Soft Drinks","Sake"]},{"name":"Sultan Sofrasi","food":["Meat","Bread","Fish"],"drinks":["Beer","Cider","Soft Drinks"]},{"name":"Spirit House","food":["Nuts","Cheese","Fruit"],"drinks":["Vodka","Gin","Rum","Tequila"]},{"name":"Tally Joe","food":["Fish","Meat","Salad","Deserts"],"drinks":["Beer","Cider","Soft Drinks","Sake"]},{"name":"Fabrique","food":["Bread","Cheese","Deli"],"drinks":["Soft Drinks","Tea","Coffee"]}]

/***/ }),
/* 3 */
/***/ (function(module, exports) {

module.exports = [{"name":"John Davis","wont_eat":["Fish"],"drinks":["Cider","Rum","Soft drinks"]},{"name":"Gary Jones","wont_eat":["Eggs","Pasta"],"drinks":["Tequila","Soft drinks","beer","Coffee"]},{"name":"Robert Webb","wont_eat":["Bread","Pasta"],"drinks":["Vokda","Gin","Whisky","Rum"]},{"name":"Gavin Coulson","wont_eat":[],"drinks":["Cider","Beer","Rum","Soft drinks"]},{"name":"Alan Allen","wont_eat":["Meat","Fish"],"drinks":["Soft drinks","Tea"]},{"name":"Bobby Robson","wont_eat":["Mexican"],"drinks":["Vokda","Gin","whisky","Rum","Cider","Beer","Soft drinks"]},{"name":"David Lang","wont_eat":["Chinese"],"drinks":["Beer","cider","Rum"]}]
...
var VenueProcess = function () {
     ...
     * @param <json> People
     */
    function VenueProcess(Venues, People) {
        _classCallCheck(this, VenueProcess);
...
var Results = function () {
    ...
    _createClass(Results, [{
        key: "addAcceptableVenue",
        value: function addAcceptableVenue(venue) {
        ...
        key: "addAvoidVenue",
        value: function addAvoidVenue(reason) {
